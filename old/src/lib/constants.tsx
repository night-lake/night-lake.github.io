...
export const projects: ProjectData[] = [
	...
	{
		name: 'QC Nicks',
		description: 'A tool to help with coloring your nickname on Queercraft.',
		website: 'https://sadie.is-a.dev/qc-nicks',
		repo: 'https://github.com/night-lake/qc-nicks',
		icon: 'none :P',
		tech: ['Nuxt.js', 'TypeScript', 'TailwindCSS']
	}
];
